  ...
  pages: {
    ...
    models: {
      ...
      form: {
        ...
        models: 'Models',
        modelsPlaceholder: 'One model id per line; click \"Probe models\" to auto-fill',
      ...
      preview: {
        ...
        warnings: {
          ...
          modelListMissing: 'Model list is missing (you can probe models first)',
      ...
      createModal: {
        ...
        flowHint: 'Flow: fill basic -> probe/confirm models -> preview -> create provider.',
      },
      messages: {
      ...
      index: {
        ...
        emptyHint: 'Add or probe models in the workbench above, then save.',
      },
    },
    dashboard: {
      hero: {
