  ...
  pages: {
    ...
    models: {
      ...
      form: {
        ...
        models: '模型列表',
        modelsPlaceholder: '一行一个模型 ID；可点击“探测模型”自动填充',
        detectedModels: '已识别',
      ...
      preview: {
        ...
        warnings: {
          ...
          modelListMissing: '未填写模型列表（可先点击“探测模型”）',
      ...
      createModal: {
        title: '新建渠道',
        flowHint: '新建流程：填写基础信息 -> 探测/确认模型 -> 查看保存预览 -> 创建渠道。',
      },
      messages: {
      ...
      validation: {
        ...
        modelsRequired: '请先探测模型或手动填写模型 ID',
      ...
      index: {
        ...
        empty: '当前未配置任何模型',
        emptyHint: '请先在上方渠道工作台中填写或探测模型并保存',
      },
    },
    dashboard: {
      hero: {
